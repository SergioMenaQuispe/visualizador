...
int main(){
	...
	A.Insert(8,4,5);
	A.Print();
	cout<<"\nFila 4 mayor: "<<A.max_row(4)<<endl;
	cout<<"Fila 4 menor: "<<A.min_row(4)<<endl;
	cout<<"Col 2 mayor: "<<A.max_col(2)<<endl;
	cout<<"Col 2 menor: "<<A.min_col(2)<<endl;
	cout<<"Maximo matrix: "<<A.max()<<endl;
	cout<<"Minimo matrix: "<<A.min()<<endl;
	cout<<"Suma fila 5: "<<A.sum_row(5)<<endl;
	cout<<"Suma col 2: "<<A.sum_col(2)<<endl<<endl;
